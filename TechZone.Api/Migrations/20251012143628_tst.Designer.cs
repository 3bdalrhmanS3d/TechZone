...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Laptop.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Laptop.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Laptop.Laptop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Laptop.LaptopImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Laptop.LaptopVariant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Laptop.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Laptop.RepairRequest", b =>
                {
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Logging.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Order.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Order.Discount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Order.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Order.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Order.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Order.Shipping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Laptop.Laptop", b =>
                {
                    b.HasOne("TechZone.Domain.Entities.Laptop.Brand", "Brand")
                        .WithMany("Laptops")
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TechZone.Domain.Entities.Laptop.Category", "Category")
                        .WithMany("Laptops")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Laptop.LaptopImage", b =>
                {
                    b.HasOne("TechZone.Domain.Entities.Laptop.Laptop", "Laptop")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Laptop.LaptopVariant", b =>
                {
                    b.HasOne("TechZone.Domain.Entities.Order.Discount", "Discount")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Laptop.RepairRequest", b =>
                {
                    ...
                    b.HasOne("TechZone.Domain.Entities.Repair.RepairServiceItem", "RepairServiceItem")
                        .WithMany("RepairRequests")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Order.CartItem", b =>
                {
                    ...
                    b.HasOne("TechZone.Domain.Entities.Laptop.LaptopVariant", "LaptopVariant")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Order.Order", b =>
                {
                    b.HasOne("TechZone.Domain.Entities.User.ApplicationUser", "ApplicationUser")
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Order.OrderItem", b =>
                {
                    ...
                    b.HasOne("TechZone.Domain.Entities.Order.Order", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Order.Shipping", b =>
                {
                    b.HasOne("TechZone.Domain.Entities.Order.Order", "Order")
                        .WithOne("Shipping")
                        .HasForeignKey("TechZone.Domain.Entities.Order.Shipping", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

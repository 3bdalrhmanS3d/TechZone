...
namespace TechZone.Infrastructure.Migrations
{
    ...
    [Migration("20251012211144_newDB")]
    partial class newDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Accessory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.AccessoryAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.AccessoryCompatibility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.AccessoryImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.AccessoryType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.LaptopPort", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.LaptopWarranty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.PriceHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.ProductDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.ProductView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Repair.RepairRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Repair.RepairServiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Shipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.StockAlert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.User.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.User.VerificationCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.UserDiscountUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TechZone.Domain.Entities.User.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Accessory", b =>
                {
                    b.HasOne("TechZone.Domain.Entities.AccessoryType", "AccessoryType")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.AccessoryAttribute", b =>
                {
                    b.HasOne("TechZone.Domain.Entities.Accessory", "Accessory")
                        .WithMany("Attributes")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.AuditLog", b =>
                {
                    b.HasOne("TechZone.Domain.Entities.User.ApplicationUser", "User")
                        .WithMany("AuditLogs")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.CartItem", b =>
                {
                    b.HasOne("TechZone.Domain.Entities.Accessory", null)
                        .WithMany("CartItems")
                        .HasForeignKey("AccessoryId");

                    b.HasOne("TechZone.Domain.Entities.LaptopVariant", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Category", b =>
                {
                    b.HasOne("TechZone.Domain.Entities.Category", "ParentCategory")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.PriceHistory", b =>
                {
                    ...
                    b.HasOne("TechZone.Domain.Entities.User.ApplicationUser", "ChangedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Rating", b =>
                {
                    ...
                    b.HasOne("TechZone.Domain.Entities.Laptop", null)
                        .WithMany("Ratings")
                        .HasForeignKey("LaptopId");
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Repair.RepairRequest", b =>
                {
                    ...
                    b.HasOne("TechZone.Domain.Entities.Repair.RepairServiceItem", "ServiceItem")
                        .WithMany("RepairRequests")
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.Shipment", b =>
                {
                    b.HasOne("TechZone.Domain.Entities.Order", "Order")
                        .WithOne("Shipment")
                        .HasForeignKey("TechZone.Domain.Entities.Shipment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TechZone.Domain.Entities.User.ApplicationUser", b =>
                {
                    b.OwnsMany("TechZone.Domain.Entities.User.RefreshToken", "RefreshTokens", b1 =>
                        {
